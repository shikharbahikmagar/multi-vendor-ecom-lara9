                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>{{ $author['books_available'] }}</td>
                                 <td>@if($author['status'] == 1) 
                                    <a href="javascript:void(0)" class="updateGenreStatus" id="author-{{ $author['id'] }}" genre_id="{{$author['id']}}">
                                    <i status="Active" style="font-size: 20px; " class="mdi mdi-check-circle-outline"></i></a>
                                 ...
                                 <td>
                                    <a href="{{ url('admin/add-edit-catalogue/'.$author['id']) }}"><i style="font-size: 20px;" class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
                                    <a href="javascript:void(0)" class="deleteCategory" id="cat-{{ $author['id'] }}" cat_id = "{{ $author['id'] }}"><i style="color:red; font-size: 20px;" class="fa fa-trash"></i></a>
                                 </td>
                              </tr>
                              @endforeach
                           </tbody>
